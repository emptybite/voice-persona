...
def _build_system_prompt(profile: PersonalityProfile) -> str:
    prompt = (
        f"You are now roleplaying this assistant persona.\n"
    ...
    if settings.tts_expression_tags_enabled:
        prompt += (
            "\nTTS expression tags for ElevenLabs:\n"
